...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s paymastercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  paymastercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded paymastercoin transaction") + "\n" +
              "  paymastercoin-tx [options] -create [commands]   " + _("Create hex-encoded paymastercoin transaction") + "\n" +
              "\n";
