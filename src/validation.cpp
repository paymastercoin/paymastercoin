...
#if defined(NDEBUG)
# error "Paymastercoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Paymastercoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PMC additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if(nHeight <= 1000)
    {
       nSubsidy = 160000 * COIN; //premine 160,000,000 PMC in 1k blocks
    }
    else if(nHeight <= 14400)
    {
       nSubsidy = 5000 * COIN; 
    }  
    else if(nHeight <= 21900)
    {
       nSubsidy = 200 * COIN;
    } 
    else if(nHeight <= 29400)
    {
       nSubsidy = 100 * COIN;
    }
    else if(nHeight <= 36900)
    {
       nSubsidy = 50 * COIN;
    }
    else if(nHeight <= 44400)
    {
       nSubsidy = 25 * COIN;
    }
    else if(nHeight <= 59400)
    {
       nSubsidy = 10 * COIN;
    }
    else if(nHeight <= 114066900)
    {
       nSubsidy = 5 * COIN;
    }
