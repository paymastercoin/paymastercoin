...
const char* BIP71_MIMETYPE_PAYMENT = "application/paymastercoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/paymastercoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/paymastercoin-paymentrequest";
