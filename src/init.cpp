...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/paymastercoin/paymastercoin>";
    const std::string URL_WEBSITE = "<https://pmcoin.biz>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Paymastercoin version %s\n", FormatFullVersion());
}
